...
<input name="newsId" type="hidden" value="<%=newsInfo.getNewsId() %>" />
<table class="table" align="center">

	<tr>
		<td>标题：</td>
		<td><input name="newsTitle" type="text" value="<%=newsInfo.getNewsTitle()%>"/></td>
	</tr>

	<tr>
		<td>信息：</td>
		<td><input name="newsInfo" type="text" value="<%=newsInfo.getNewsInfo()%>"/>
		 </td>
	</tr>
	<tr>
		<td>日期：</td><td><input name="newsDate" type="text" value="<%=newsInfo.getNewsDate()%>"/></td>
	</tr>
	
	<tr>
		<td>图片：</td>
		<td><input name="newsPic" type="file" value="<%=newsInfo.getNewsPic()%>"/></td>
	</tr>
	<tr>
		<td>详情：</td>
